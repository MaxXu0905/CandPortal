...
<div id="regist-wrap" class="center-block">
...
<!-- 二维码 -->
<div id="qrcode" class="center-block" style="display:none">
	<div class="i-skill-mask"></div>
	<div class="qrcodeWrap">
	<div class="code_top">关注百一微测试<img id="closeqrCode" src="<%=request.getContextPath() %>/core/images/close.png" style="margin-left:370px;margin-top:2px;"></div>
	<div class="codetext">
		<img id="qrcode-pic"  width="112" height="117">
		<div class="slogan">微信扫一扫<br>测评结果早知道</div>
	</div>
	</div>
</div>
<!--end 二维码 -->
