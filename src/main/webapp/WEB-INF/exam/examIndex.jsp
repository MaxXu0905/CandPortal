	...
	<!-- 主页面 -->
		<div id="exam-wrap" class="main-wrap">
			...
			<div class="operate-wrap" id="operate-wrap">
					...
					<div  style="position: absolute;left:95px;top:145px;"><span id = "examTimeAlert" style="color: #666;font-size: 18px;"></span></div>
					<!--end 监控 -->
					<!-- 倒计时 -->
					...
					<div id="bottombtnarea" class="bottom_content">
						<div class="btnarea" >
							<div  class="skipbtn" style="text-align:left;margin-bottom: 15px;"><a id="prev" style="text-decoration: underline;display:none">上一题</a></div>
  ...
  <div class="modal-dialog">
	...
	<div class="navbar-fixed-bottom">
		<div style="text-align:right" >
			<span id="openQuestionPanel" href="" class="btn btn-primary"  style="display: none;"><span class="fa fa-angle-double-up fa-lg" style="font-size: 1.8em;"></span> 题目面板</span>
		</div>
     	<div id="questionPanel" class="none"></div>
	</div>
	<!--end 题板 -->
		<!--footer -->
		...
		<script type="text/javascript"
			src="<%=request.getContextPath()%>/plugin/jpeg_encoder_basic.js"></script>
			 <script type="text/javascript"
			src="<%=request.getContextPath()%>/plugin/html5shiv.js"></script>
	    <script type="text/javascript"
...
<script id="questionPanelTmpl" type="text/x-jsrender">
		<button id="closeQuestionPanel" type="button" class="close" ><span aria-hidden="true">×</span><span class="sr-only">Close</span></button>
		   <div>
				{{for questionIds}}
		   		<button  id="{{:questionId}}" type="button"  questionId data-link="class{:answered==1?'btn answered':'btn unAnswer'}">{{:#index+1}}</button>
				{{/for}}		  
 			</div>
</script>
</body>
